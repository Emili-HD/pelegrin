...
function pele_destacados(){
	...
	if ($sale_product->have_posts(  )):
		...
		while ( $sale_product -> have_posts(  ) ) : $sale_product -> the_post(  );
			...
			?>
				<div class="productos__destacados-producto">
					<div class="productos__destacados-producto-wishlist">
					...
					<h3 class="productos__destacados-producto-titulo"><?php the_title();?></h3>
					<div class="productos__destacados-producto-imagen" style="background-image: url(<?php echo $product_thumbnail[0];?>); background-position: center; background-size: cover;"></div>
					<div class="producto-inferior">
						<div class="productos__destacados-producto-precios">
							desde
						...
						<a href="<?php echo $link; ?>" class="productos__destacados-producto-opciones">
